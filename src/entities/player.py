...
class Player:
    def __init__(self, x, y, width, height, texture=None, color=None):
        ...
        idle_animation = Animation([pygame.image.load("assets/textures/idle.png"), pygame.image.load("assets/textures/idle.png")])
        walk_animation = Animation([pygame.image.load("assets/textures/walk1.png"), pygame.image.load("assets/textures/walk2.png"), pygame.image.load("assets/textures/walk3.png")])
        jump_animation = Animation([pygame.image.load("assets/textures/jump.png",),pygame.image.load("assets/textures/jump.png"),pygame.image.load("assets/textures/jump.png")])
        death_animation = Animation([pygame.image.load("assets/textures/death.png"), pygame.image.load("assets/textures/death.png")])
        self.animations = {
            "idle": idle_animation,
            "walk": walk_animation,
            "jump": jump_animation,
