...
class Enemy:
    def __init__(self, x, y, width, height, speed, texture=None, color=None):
        ...
        if not self.texture and not self.color:
            self.color = (255, 0, 0) 
        death_animation = Animation([pygame.image.load("assets/textures/enemy_die.png"), pygame.image.load("assets/textures/enemy_die.png")])
        idle_animation = Animation([pygame.image.load("assets/textures/a.png"), pygame.image.load("assets/textures/a.png")])
        walk_animation = Animation([pygame.image.load("assets/textures/enemy_1.png"), pygame.image.load("assets/textures/enemy_2.png")])
